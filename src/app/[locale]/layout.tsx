...
const serviceAreas = ['Longueuil', 'Brossard', 'Saint-Hubert', 'La Prairie', 'Boucherville', 'Sainte-Julie', 'Laval']
...
function buildSchemas(locale: string) {
  ...
  const localBusiness = {
    ...
    description: isFr
      ? "Spécialiste en revêtement polyaspartique de plancher de garage. Installation professionnelle en 1 jour. Service Rive-Sud & Laval."
      : "Garage floor polyaspartic coating specialist. Professional installation in 1 day. Serving South Shore & Laval.",
      ...
      images: [
        {
          ...
          height: 630,
          alt: locale === 'fr'
            ? 'Garage Express — Plancher polyaspartique professionnel Rive-Sud & Laval'
            : 'Garage Express — Professional polyaspartic garage floor South Shore & Laval',
        },
      ],
