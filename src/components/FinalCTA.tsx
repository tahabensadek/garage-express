...
export default function FinalCTA() {
  ...
  return (
    <section className="py-24 bg-primary relative overflow-hidden">
      ...
      <div className="orb-1 absolute w-[36rem] h-[36rem] rounded-full blur-3xl opacity-20 bg-red-900 pointer-events-none" style={{ top: '-30%', left: '-15%' }} />
      <div className="orb-2 absolute w-80 h-80 rounded-full blur-3xl opacity-15 bg-orange-600 pointer-events-none" style={{ bottom: '-20%', right: '-10%' }} />
      <div className="orb-3 absolute w-60 h-60 rounded-full blur-3xl opacity-10 bg-white pointer-events-none" style={{ top: '20%', right: '30%' }} />
